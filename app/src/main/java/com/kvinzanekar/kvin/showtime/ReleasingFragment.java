 ...
 */
public class ReleasingFragment extends Fragment {
    ...
    private String releasingThisWeek = "http://www.kvinzanekar.com/webservices/api/v1/releasing-this-week";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_releasing_this_week, container, false);
        listView = (ListView)rootView.findViewById(R.id.list);
        adapter = new CustomListViewAdapter(getActivity(), R.layout.list_row, movies);
        listView.setAdapter(adapter);

        JsonArrayRequest arrayRequest = new JsonArrayRequest(Request.Method.GET, releasingThisWeek, new Response.Listener<JSONArray>() {
            @Override
